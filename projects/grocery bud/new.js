...
//      let idCount = randy()
//      const listObj = { value, idCount, index };
//      if (value && !editValue) {
//           index++;
...
//      const item = e.target;
//      const id = (e.target as EventTarget)?.parentElement.parentElement.id;
//      console.log(id)
//      if (id && (e.target as HTMLInputElement).classList.contains("delete_btn")) {
